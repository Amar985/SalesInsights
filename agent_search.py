...
# AGENT_ENDPOINT = ""
from config import load_config # Add this import


    # ... rest of the code
AGENT_NAME = "AgentForWebCrawlingV2"
AGENT_VERSION = "2"
...
def search_company_options(query: str) -> List[Dict]:
    ...
    config = load_config() # Load config to get the endpoint
    client = AIProjectClient(
        endpoint=config.azure_foundry_project_endpoint, # Use dynamic config,
